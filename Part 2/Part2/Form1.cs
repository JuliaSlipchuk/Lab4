...
namespace Part2
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                count++;
                var key = inputStringBuilder[i].ToString() + inputStringBuilder[i + 1];
            ...
            label2.Text = string.Join(", ", frequency.OrderByDescending(f => f.Value).Select(f => f.Key).Take(30));

            FillChart();

            Form2 form2 = new Form2(frequency);
            form2.Show();
        }
        ...
        private DataTable GetResultForDataGridView()
        {
            ...
            table.Columns.Add("Bigram", typeof(string));
